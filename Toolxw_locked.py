...
REMOTE_SERVER_URL = os.getenv("TOOLXW_SERVER_URL", "https://YOUR-TOOLXW-SERVICE.onrender.com").rstrip("/")
REMOTE_SERVER_SECRET = os.getenv("TOOLXW_SERVER_SECRET", "CHANGE_ME")
